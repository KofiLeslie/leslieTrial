            ...
            [
                ...
                function (t, e, n) {
                    var i = n(5),
                        ...
                        s = Array.prototype;
                    null == s[r] &&
                        n.f(s, r, { configurable: !0, value: o(null) }),
                        (t.exports = function (t) {
                            s[r][t] = !0;
                        });
                },
                ...
                function (t, e, n) {
                    ...
                    class Pt extends e {
                        constructor(t) {
                            super(t),
                                (this._fn = {}),
                                this._element &&
                                    (u.setData(this._element, Tt, this),
                                    this._init());
                        }
                        static get NAME() {
                            return Ct;
                        ...
                        _bindClick() {
                            O.on(this._actionButton, Ot, () => {
                                L.hasClass(this._element, "active")
                                    ? this.hide()
                                    : this.show();
                            });
                        }
                    ...
                    var Bt = {
                        ...
                        getDataAttribute(t, e) {
                            return Ht(
                                t.getAttribute("data-mdb-".concat(Rt(e)))
                            );
                        },
                        offset(t) {
                            t = t.getBoundingClientRect();
                    ...
                    var ve = class {
                        ...
                        deactivate() {
                            this._isActive &&
                                ((this._isActive = !1), pt.off(document, fe));
                        }
                        _handleFocusin(t) {
                            t = t.target;
                    ...
                    pt.on(
                        ...
                        pt.on(window, yt, () =>
                            Wt.find(Ee).forEach((t) =>
                                Se.getOrCreateInstance(t).show()
                            )
                        ),
                        _e(Se),
                        K(Se);
                    ...
                    class cn extends bt {
                        ...
                        _addEventListeners() {
                            this._config.keyboard &&
                                pt.on(this._element, Ge, (t) =>
                                    this._keydown(t)
                                ),
                                "hover" === this._config.pause &&
                                    (pt.on(this._element, $e, (t) =>
                                        this.pause(t)
                                    ),
                                    pt.on(this._element, Ze, (t) =>
                                        this.cycle(t)
                                    )),
                                this._config.touch &&
                                    this._touchSupported &&
                    ...
                    class kn extends bt {
                        ...
                        _triggerBackdropTransition() {
                            if (
                                !pt.trigger(this._element, yn).defaultPrevented
                            ) {
                                const {
                                        classList: t,
                                        scrollHeight: e,
                    ...
                    function _i(t) {
                        return (
                            t instanceof mi(t).Element || t instanceof Element
                        );
                    }
                    function vi(t) {
                        return (
                            t instanceof mi(t).HTMLElement ||
                    ...
                    var yi = {
                        ...
                        effect: function (t) {
                            ...
                            return (
                                Object.assign(
                                    i.elements.popper.style,
                                    o.popper
                                ),
                                (i.styles = o),
                                i.elements.arrow &&
                                    Object.assign(
                                        i.elements.arrow.style,
                                        o.arrow
                                    ),
                                function () {
                                    Object.keys(i.elements).forEach(function (
                                        t
                                    ) {
                                        var e = i.elements[t],
                                            n = i.attributes[t] || {},
                    ...
                    function Li(t) {
                        return (
                            (_i(t) ? t.ownerDocument : t.document) ||
                            window.document
                        ).documentElement;
                    }
                    function Ii(t) {
                    ...
                    function ki(t) {
                        return vi(t) && "fixed" !== Si(t).position
                            ? t.offsetParent
                            : null;
                    }
                    function Di(t) {
                    ...
                    function Zi(t, e) {
                        ...
                        var n = (function t(e) {
                                return 0 <=
                                    ["html", "body", "#document"].indexOf(gi(e))
                    ...
                    function io(t, e) {
                        var i,
                            ...
                            o = eo(
                                _i(o)
                                    ? o
                                    : o.contextElement || Li(t.elements.popper),
                                a,
                                e
                            ),
                    ...
                    class Ro extends bt {
                        ...
                        _enter(t, e) {
                            (e = this._initializeOnDelegatedTarget(t, e)),
                                t &&
                                    (e._activeTrigger[
                                        "focusin" === t.type ? Ho : Mo
                                    ] = !0),
                                e.getTipElement().classList.contains(ko) ||
                                e._hoverState === Do
                                    ? (e._hoverState = Do)
                            ...
                            i && "LI" === i.nodeName && (i = i.parentNode),
                                i &&
                                    ...
                                    ((e = t.closest(".dropdown")) &&
                                        Wt.find(".dropdown-toggle", e).forEach(
                            ...
                            if (
                                ...
                                this._previous &&
                                    ...
                                    O.trigger(this._element, Dr, {
                                        ...
                                        i
                                            ? this._activate(i, i.parentNode, o)
                                            : o());
                            }
                        }
                        _init() {
                    ...
                    class fs extends bt {
                        ...
                        _setListeners() {
                            pt.on(this._element, es, (t) =>
                                this._onInteraction(t, !0)
                            ),
                                pt.on(this._element, ns, (t) =>
                                    this._onInteraction(t, !1)
                                ),
                                pt.on(this._element, is, (t) =>
                                    this._onInteraction(t, !0)
                                ),
                                pt.on(this._element, os, (t) =>
                                    this._onInteraction(t, !1)
                                );
                        }
                        _clearTimeout() {
                    ...
                    class Hs {
                        ...
                        _getCounter() {
                            (this._counter = L.getDataAttribute(
                                this.input,
                                "showcounter"
                            )),
                                this._counter &&
                    ...
                    O.on(document, "focus", ks, Hs.activate(new Hs())),
                        ...
                        O.on(window, "shown.bs.tab", (t) => {
                            ...
                            e = (
                                t.target.href ||
                                L.getDataAttribute(t.target, "target")
                            ).split("#")[1];
                    ...
                    class ra extends bt {
                        ...
                        show() {
                            if (
                                ...
                                if (
                                    !pt.trigger(this._element, Vs, t)
                                        .defaultPrevented
                                ) {
                                    const e = ra.getParentFromElement(
                                        this._element
                                    );
                                    this._inNavbar
                                        ? Bt.setDataAttribute(
                            ...
                            var { layerX: e, layerY: n } = t,
                                ...
                                e = {
                                    ...
                                    top: this._options.rippleCentered
                                        ...
                                        : "".concat(o - n, "px"),
                                    height: "".concat(
                                        2 * this._options.rippleRadius || e,
                                        "px"
                                    ),
                                    width: "".concat(
                                        2 * this._options.rippleRadius || e,
                    ...
                    class Ra {
                        ...
                        _handleEvents() {
                            O.on(this.rangeInput, "mousedown", () =>
                                this._showThumb()
                            ),
                                O.on(this.rangeInput, "mouseup", () =>
                                    this._hideThumb()
                                ),
                                O.on(this.rangeInput, "touchstart", () =>
                                    this._showThumb()
                                ),
                                O.on(this.rangeInput, "touchend", () =>
                                    this._hideThumb()
                                ),
